...
function welcome() {
  ...
  console.log(
    '\x1b[33m',
    'Please wait while we communicate to the database...\n',
    '\x1b[0m'
  )
}
  ...
  return await fs.writeFile(
    ...
    err => {
      if (err) {
        ...
        console.log(
          '\x1b[31m',
          `Could not save ${filename} into ${ELEVENTY_DATA_PATH}!`
        )
        console.log(err)
        return 1
      } else {
...
function pullData() {
  ...
  pullMajorsData()
    .then(majorsData => {
      ...
      saveData('majors.json', majorsData)
        .then(() => {
          ...
          pullStudentData(majorsData)
            .then(studentData => {
              ...
              saveData('studentData.json', studentData)
                .then(() => {
                  ...
                  parseStudentList(studentData)
                    .then(studentList => {
                      ...
                      saveData('studentList.json', studentList)
                        ...
                        .catch(error => {
                          ...
                          console.log(
                            '\x1b[31m',
                            '[ERROR] - An error occured during saveData of student list!'
                          )
                    ...
                    .catch(error => {
                      ...
                      console.log(
                        '\x1b[31m',
                        '[ERROR] - An error occured when parsing student lists!'
                      )
                      console.error('\x1b[31m', error, '\n\n')
                      return process.exit(5)
                    })
                ...
                .catch(error => {
                  ...
                  console.log(
                    '\x1b[31m',
                    '[ERROR] - An error occured during saveData of student data!'
                  )
                  console.error('\x1b[31m', error, '\n\n')
                  return process.exit(5)
                })
            ...
            .catch(error => {
              ...
              console.log(
                '\x1b[31m',
                '[ERROR] - An error occured when processing student data!'
              )
              console.error('\x1b[31m', error, '\n\n')
              return process.exit(5)
            })
        ...
        .catch(error => {
          ...
          console.log(
            '\x1b[31m',
            '[ERROR] - An error occured during saveData of Majors Data!'
          )
          console.error('\x1b[31m', error, '\n\n')
          return process.exit(5)
        })
    ...
    .catch(error => {
      ...
      console.log(
        '\x1b[31m',
        '[ERROR] - An error occured when pulling majors from the database!'
      )
      console.error('\x1b[31m', error, '\n\n')
      return process.exit(5)
    })
